...
<Lightbox src="centos/fig01.avif" alt="fig01"/>
...
<Lightbox src="centos/fig02.avif" alt="fig02"/>
...
<Lightbox src="centos/fig03.avif" alt="fig03"/>

## 安裝 Centos 7

點擊兩下執行安裝。安裝會自動執行。最後會要你輸入任何按鍵以繼續，就完成安裝了。

<Lightbox src="centos/fig04.avif" alt="fig04"/>
...
<Lightbox src="centos/fig05.avif" alt="fig05"/>
...
<Lightbox src="centos/fig06.avif" alt="fig06"/>
